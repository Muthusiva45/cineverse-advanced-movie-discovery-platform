    ...
    >
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-cinema-muted">
          Filter OMDb results by format and year, then sort the current page by title, release year, or IMDb rating.
        </p>
      </div>

      <div className="mt-8 grid gap-4 lg:grid-cols-[1fr_26rem]">
        ...
        <>
          ...
          {totalResults > 10 ? (
            <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
              <button
                className="h-11 rounded-md border border-white/10 px-5 font-bold text-white transition hover:border-cinema-red disabled:cursor-not-allowed disabled:opacity-40"
                disabled={page === 1}
              ...
              <span className="text-sm font-semibold text-cinema-muted">
                Page {page} of {pageCount}
              </span>
              <button
                className="h-11 rounded-md bg-cinema-red px-5 font-bold text-white transition hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-40"
